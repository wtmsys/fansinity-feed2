...
class SitemapServiceProvider extends ServiceProvider
{
    ...
    public static function generateSitemap()
    {
        ...
        foreach ($creators as $user) {
            $sitemapData .= '
           <url>
              <loc>'.str_replace('http://localhost/',rtrim(getSetting('site.app_url'),'/').'/',route('profile', ['username' => $user->username])).'</loc>
        ...
        foreach ($publicPages as $page) {
            $sitemapData .= '
           <url>
              <loc>'.str_replace('http://localhost/',rtrim(getSetting('site.app_url'),'/').'/',route('pages.get', ['slug' => $page->slug])).'</loc>
