                        ...
                        <div class="modal-body">
                            ...
                            <span class="input-group-text" id="amount-label">
                                @include('elements.icon',['icon'=>'cash-outline','variant'=>'medium','centered'=>false])
                                    ...
                                    <input class="form-control" placeholder="{{__('Amount ($5 min, $500 max)',['min'=>1,'max'=>500,'currency'=>config('app.site.currency_symbol')])}}" aria-label="Username" aria-describedby="amount-label" id="checkout-amount" type="number" min="0" step="1" max="500">
