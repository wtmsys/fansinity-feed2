            ...
            <div class="pt-4 d-flex justify-content-between align-items-center px-3 pb-3 border-bottom">
                ...
                <div class="d-flex">
                    ...
                    <div class="stream-off-label w-100 {{StreamsHelper::getUserInProgressStream() ? 'd-none' : ''}}">
                        <button class="btn btn-outline-danger btn-sm px-3 mb-0 d-flex align-items-center" onclick="Streams.showStreamEditDialog('create')" data-toggle="tooltip" data-placement="top" title="{{__('Go live')}}">
